...
use app\assets\AdDetailsAsset;
use yii\helpers\VarDumper;

//VarDumper::dump($ad, 3, true);
//VarDumper::dump($adImages, 3, true);
//VarDumper::dump($imageUrl, 3, true);
//
//die();
AdDetailsAsset::register($this);
?>
            ...
            <div class="row">
                <div class="col-sm-9 page-content col-thin-right">
                    <div class="inner inner-box ads-details-wrapper">
                        ...
                        <span class="info-row"> <span class="date"><i class=" icon-clock"> </i> <?= $ad["creation_date"] ?> </span>
                            - 
<!--                                    <span
                                class="category">Electronics </span>- -->
                            <span class="item-location"><i
                                    class="fa fa-map-marker"></i> <?= $ad["place_name"] ?> </span> </span>

                        <div class="ads-image">
                            <h1 class="pricetag"> 
                                <?php
                                if ($ad["price_unit"] == "lira") {
                                    echo $ad["price"] . "L.L.";
                                } else {
                                    echo "$" . $ad["price"];
                                }
                            ...
                            <ul class="bxslider">
                                <?php
                                for ($i = 0; $i < sizeof($adImages); $i++) {
                                    ?>
                                    <li><img src="<?= $imageUrl . $adImages[$i]["picture_name"] ?>" alt="img"/></li>
                                    <?php
                                }
                                ?>
                            ...
                            <div id="bx-pager">
                                ...
                                for ($i = 0; $i < sizeof($adImages); $i++) {
                                    ...
                                    <a class="thumb-item-link" data-slide-index="<?= $i ?>" href=""><img
                                            src="<?= $imageUrl . $adImages[$i]["picture_name"] ?>" alt="img"/></a>
                                        <?php
                                    }
                                    ?>
                        ...
                        <div class="Ads-Details">
                            ...
                            <div class="content-footer text-left"><a class="btn  btn-default" data-toggle="modal"
                                        ...
                                        class=" icon-phone-1"></i> <?= $ad["phone"] ?> </a></div>
                        </div>
                    </div>
                    <!--/.ads-details-wrapper-->
                            ...
                            <div class="panel-content user-info">
                                <div class="panel-body text-center">
                                    <div class="seller-info">
                                        <h3 class="no-margin"><?= $ad["clientName"] ?></h3>

                                        <p>Location: <strong><?= $ad["place_name"] ?></strong></p>

                                        <p> Joined: <strong><?= $ad["creation_date"] ?></strong></p>
                                    </div>
                                    <div class="user-ads-action"><a href="#contactAdvertiser" data-toggle="modal"
                                                                    class="btn   btn-default btn-block"><i
                                                class=" icon-mail-2"></i> Send a message </a> <a
                                            class="btn  btn-info btn-block"><i class=" icon-phone-1"></i> <?= $ad["phone"] ?>
                                        </a></div>
                                </div>
                            </div>
                        </div>
